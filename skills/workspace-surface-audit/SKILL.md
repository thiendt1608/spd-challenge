...
description: Audit the active repo, MCP servers, plugins, connectors, env surfaces, and harness setup, then recommend the highest-value ECC-native skills, hooks, agents, and operator workflows. Use when the user wants help setting up a coding-agent environment or understanding what capabilities are actually available in their environment.
origin: ECC
---
...
- User says "set up my coding agent", "recommend automations", "what plugins or MCPs should I use?", or "what am I missing?"
...
1. Repo surface
   ...
   - `.mcp.json`, `.lsp.json`, `.codex/*`
   - `AGENTS.md`, install manifests, hook configs
...
- official marketplace plugins that overlap with setup, review, docs, design, or workflow quality
- locally installed plugins in your active coding environment
