    ...
    <div className="w-full max-w-3xl mx-auto space-y-6 bg-gray-800/70 backdrop-blur-md p-8 rounded-adyen border border-white/20 shadow-2xl">
      <div className="space-y-4 text-left">
        ...
        <textarea 
          ...
          className="w-full min-h-[150px] bg-white/15 border border-white/30 text-white rounded-adyen p-4 text-base resize-none focus:outline-none focus:ring-2 focus:ring-[#00d16a] focus:border-transparent placeholder:text-white/50"
        />
